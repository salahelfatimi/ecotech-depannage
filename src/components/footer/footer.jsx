    ...
    return(
      <footer className="flex flex-col " >
        <div className="bg-[#0276FF] py-8 ">
            ...
            <Link target="_blank" href={'mailto:ecotech.depannage@gmail.com'}  className=" flex gap-4"><Mail size={30} className=" stroke-[#fff]" /><span className=" text-xl items-center font-medium  text-center lg:text-start text-white ">ecotech.depannage@gmail.com</span></Link>
            <Link target="_blank" href={"tel:+33771710513"}  className=" flex gap-4"><Phone size={30} className=" stroke-[#fff]" /><span className=" text-xl items-center font-medium capitalize text-center lg:text-start text-white ">+33 7 71 71 05 13</span></Link>
