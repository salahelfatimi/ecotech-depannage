...
export default function Service(){
    const service=[
        ...
        {title:'Plomberie', description:"Pour les fuites, les toilettes bouchées ou les pannes d'eau chaude, faites appel à notre réseau de plombiers expérimentés via abintervetioneurope.fr pour une intervention rapide et efficace.",image:Plomberie},
        ...
        {title:'Chauffage', description:"Choisissez ElecFixePro pour l'installation et la réparation de vos systèmes de chauffage. Service rapide, fiable et sur mesure pour un confort optimal et une efficacité énergétique maximale.",image:Chauffage},
        {title:'Installation Borne De Recharge', description:"Avec Grit Service, optez pour ElecFixePro pour l'installation et la réparation de bornes de recharge. Bénéficiez d'un service rapide, fiable et de haute qualité.",image:installationBorneDeRecharge},
        ...
        {title:'Vitrerie & Miroiterie', description:'En cas de bris de glace ou de besoin de remplacer un miroir ou un plateau de verre, ElecFixePro vous connecte à des vitriers qualifiés pour des réparations rapides et efficaces.',image:VitrerieMiroiterie},
