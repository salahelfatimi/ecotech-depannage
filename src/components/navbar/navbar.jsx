                ...
                <div className="bg-[#0276FF] p-2">
                    <div className="container flex flex-row justify-between items-center">
                        ...
                        <div className="flex gap-2 justify-between">
                            ...
                            <Link target="_blank" href={'https://wa.me/+33771710513'}   className="flex gap-2 font-medium bg-white py-2 px-4 rounded-full  text-[#0276FF] items-center"><Phone size={20} /><span className="lg:block hidden " >+33 7 71 71 05 13</span></Link>
