...
export default function PhoneIcon(){
    return(
        <div className=" z-50 flex gap-2 items-center  animate-bounce  fixed bottom-4 right-4 ">
        ...
        <Link href={'https://wa.me/+33771710513'} className="bg-green-600 w-fit p-4 rounded-full ">
