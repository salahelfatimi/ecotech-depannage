      ...
      <>
        {isVisible && (
            ...
            <div className="container flex flex-col items-center mx-auto max-w-md bg-gray-800 rounded-lg shadow-lg p-6">
              ...
              <p className="text-sm text-center mb-4"> Ce site utilise des cookies pour améliorer votre expérience. Consultez notre{" "} <Link href="/politique-de-confidentialite" className="text-[#0276FF] underline hover:text-[#0276FF]" > politique de confidentialité </Link> . </p>
                <div className="flex gap-4 justify-center">
                    <button className="bg-[#0276FF] text-gray-900 font-semibold py-2 px-4 rounded hover:bg-transparent border-2 border-[#0276FF] hover:text-[#0276FF] transition" onClick={() => handleCookiesDecision(true)} > Accepter </button>
